...
| TC 1.5 |  If no category is selected no functionality should be occuring for "ok or cancel" | Not selecting any category and click on "ok or cancel" button/link. | Upon no selection  User is not enabled with "Ok /Cancel" buttons | Valid Url for setting pages|  |  |    
| TC 1.6 |  If no category is selected no functionality should be occuring for "ok or cancel" | Not selecting any category and click on "ok or cancel" button/link. | Upon no selection  User is not enabled with "Ok /Cancel" buttons | Valid Url for setting pages|  |  |    
